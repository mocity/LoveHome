			...
			<form id="postadd" name="postadd" method="post" action="p?ac=add">		
				<div id="addleftc">
					...
					<div id="ptitle">
						...
						<input id="title" name="title" class="qpub-text placeholder" type="text" />
						</span>
					</div>
					<div id="pcont">
						<div style="margin-bottom:15px; font-size:14px;">内容</div>
						<script type="text/plain" id="myEditor" name="content" style="width:655px"></script>
					...
					<div id="pbtn">
					<input type="text" hidden="hidden" name="uid" value='1' />
